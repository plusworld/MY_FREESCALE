...
/***MODU-********************************************************************/
#ifndef __K60_VECTORS_H__
#define __K60_VECTORS_H__

/***DEF+**********************************************************************/
/*define Open/close ISR.                                                     */
/***DEF-**********************************************************************/
/*!< Macro to enable all interrupts. */

#define EnableInterrupts      do {asm(" CPSIE i");} while(0)

/*!< Macro to disable all interrupts. */

#define DisableInterrupts     do {asm(" CPSID i");} while(0)

/***DEF+**********************************************************************/
/* define ISR number.                                                        */
/***DEF-**********************************************************************/
#define  MAX_IRQ_NUM        91
#define  IRQ_NUM_UART3      51
...
#define VECTOR_017      DMA_CH1_Handler     // 0x0000_0044 17     1     DMA              DMA Channel 1 transfer complete
...
#define VECTOR_105      PORTC_Interrupt     // 0x0000_01A4 105   89 Port control module Pin Detect (Port C)
